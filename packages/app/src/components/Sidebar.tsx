  ...
  return (
    <div className="sidebar-inner">
      ...
      <div className="sidebar-foot">
        ...
        <a className="link muted" href="https://github.com/shuw/taxonomy/issues" target="_blank" rel="noreferrer" title="A problem, a wrong number, an idea: it goes to the project's issues on GitHub">Feedback</a>
      </div>
    </div>
  );
}
