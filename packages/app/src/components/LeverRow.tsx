...
export function LeverRow({ label, hint, year, available, value, mark, over, sharesBeforeAmt, spread, onChange }: Props) {
    ...
    <div className="lever-row">
      ...
      <div className="foot">
        <span className={over ? "over" : ""}>
          {available === 0 ? `nothing exercisable in ${year}` : mark === null ? "" : over ? `${shares(value - sharesBeforeAmt)} past the AMT line` : `AMT-free up to ${shares(sharesBeforeAmt)}`}
        </span>
